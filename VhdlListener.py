...
class vhdlListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by vhdlParser#range_base.
    def enterRange_base(self, ctx:vhdlParser.Range_baseContext):
        pass

    # Exit a parse tree produced by vhdlParser#range_base.
    def exitRange_base(self, ctx:vhdlParser.Range_baseContext):
        pass
